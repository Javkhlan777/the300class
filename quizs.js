document.addEventListener("DOMContentLoaded", function () {
    ...
    addQuestionsBtn.addEventListener("click", function () {
      ...
      form.addEventListener("submit", function (event) {
        ...
        showSuccessModal("Амжилттай асуулт орууллаа!");
    ...
    playQuizBtn.addEventListener("click", function () {
      ...
      <div class="quiz-container">
        <h3>Play Quiz</h3>
        <p>Таагаад шагналаа ав!</p>
        <button id="start-quiz-btn" class="start-quiz-button">Start</button>
                    ...
                    .addEventListener("click", function () {
                      ...
                      if (playerName) {
                        ...
                        if (playerIndex !== -1) {
                          ...
                          leaderboard[playerIndex].points += 100;
                        } else {
